...
### Core Focus
I build model-driven solutions at the intersection of mathematical theory and applied machine learning. My work spans reinforcement learning for adaptive pedagogy, RAG-based systems for knowledge discovery, and bioinformatics research focused on pancancer genomics.

---

### Featured Research
**First-Author Researcher | Harvard OpenBio Student Research Institute**
- Investigated pancancer tumor mutation effects on gene expression using unsupervised learning (PCA, Partial Least Squares Regression) on mRNA-sequencing data from The Cancer Genome Atlas (3527 Tumors).
- Authored a 30-page research paper; abstract to be published in the Harvard-affiliated issue of the STEM Fellowship Journal.
